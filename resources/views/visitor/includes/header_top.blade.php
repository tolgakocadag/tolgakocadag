        ...
        <div class="row">
            <div class="col-md-3">
                <div class="vk-between-header-logo">
                    <a href="/"><img src="{{ asset('public_assets/logo/') }}/tolgakocadag_325x129_low.png" alt="" class="img-responsive img-logo"></a>
                </div>
            </div>
            {{-- <div class="col-md-8 col-md-offset-1">
                <div class="vk-between-header-banner">
                    <a href="#"><img src="{{ asset('public_assets/image/') }}/ad-header.jpg" alt="" class="img-responsive"></a>
                </div>
            </div> --}}
        </div>
    </div>
